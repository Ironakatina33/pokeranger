...
Ouvre `index.html` dans un navigateur moderne. Aucune dépendance, aucun serveur requis.
...
Ce projet est un **hommage de gameplay uniquement**. Aucune marque, aucun nom, aucun sprite,
aucun son ni aucune cinématique officiels ne sont utilisés ou reproduits. Tout l'univers
(noms, personnages, créatures, lieux, lore, UI) est original.